...
/* Dark mode */
[data-theme="dark"] .language-button { background: rgba(255,255,255,0.1); border-color: rgba(255,255,255,0.15); color: #e2e8f0; }
[data-theme="dark"] .language-button:hover { background: rgba(255,255,255,0.15); border-color: rgba(255,255,255,0.25); }
[data-theme="dark"] .globe-icon { color: #94a3b8; }
...
[data-theme="dark"] .dropdown-item.active { background: rgba(13,148,136,0.15); color: #2dd4bf; }
[data-theme="dark"] .check-icon { color: #2dd4bf; }
</style>
